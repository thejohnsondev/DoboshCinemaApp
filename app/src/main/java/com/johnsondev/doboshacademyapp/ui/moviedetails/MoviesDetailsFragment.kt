...
class MoviesDetailsFragment : BaseFragment() {
    ...
    override fun initViews(view: View) {
        ...
        contentViewPager = view.findViewById(R.id.movie_view_pager)

        contentViewPager.adapter = MovieDetailsPagerAdapter(this)
        contentViewPager.offscreenPageLimit = 1


        TabLayoutMediator(tabLayout, contentViewPager) { tab, pos ->
            tab.text = MOVIE_TAB_TITLES[pos]
            contentViewPager.setCurrentItem(tab.position, true)
    ...
    private fun hideViews() {
        ...
        contentViewPager.isVisible = false
